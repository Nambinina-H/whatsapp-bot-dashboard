    ...
    <div className={cn('relative', className)}>
      ...
      {value.length > 0 && (
        <button
          ...
          className="absolute right-1 top-1/2 inline-flex size-9 -translate-y-1/2 items-center justify-center rounded-md text-slate-400 hover:bg-slate-200 hover:text-slate-600 md:right-2 md:size-6"
        >
